                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: GridView.count(
                      crossAxisCount: 3,
                      children: search.length==0?asilListe:asilListe.cast<ListeButon>().where((element) => element.index.toString().contains(search)).toList(),
              ...
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: seciliWidget.length==0?[Transform.rotate(angle: -2*pi/180,child:Container(height: 44,width:88,color: Colors.amber,child: Text("Ekleme yapılmadı"),) ,),]:seciliWidget,
                  ),
                ),
              ),
            ),
